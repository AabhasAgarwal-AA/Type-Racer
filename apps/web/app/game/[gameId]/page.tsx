            ...
            <main className="mx-auto max-w-5xl w-full mt-10 p-5">
                <Card className="w-full flex flex-col p-10">
                    ...
                    <p className="text-grey-400 mt-5 text-lg">
                        Before you join the game, we require you to provide a nickname/username. This name will be shown in the leaderboard and in the participants section
                    </p>

                    <form action={appendName} className="mt-10">
                        <Input type="text" placeholder="Name" name="name" className="text-xl px-5 py-7" />
                        <Button type="submit" className="text-xl w-full mt-5 px-5 py-7"> Join Game</Button>
                    </form>
                </Card>
